...
class PySdv(PythonPackage):
    ...
    with when("@0.18:"), default_args(type=("build", "run")):
        ...
        depends_on("py-copulas@0.6.0:")
        depends_on("py-ctgan@0.7.0:")
        depends_on("py-deepecho@0.4.0:")
        depends_on("py-rdt@1.3.0:")
        depends_on("py-sdmetrics@0.9:")
        depends_on("py-cloudpickle@2.1:2")

    with when("@0.14:"), default_args(type=("build", "run")):
        depends_on("py-faker@9:")
        depends_on("py-graphviz@0.13.2:0")
        depends_on("py-numpy@1.20:1")
        depends_on("py-pandas@1.1.4:")
        depends_on("py-tqdm@4.15:4")
        depends_on("py-copulas@0.6.0:")
        depends_on("py-ctgan@0.5.0:")
        depends_on("py-deepecho@0.3.0:")
        depends_on("py-rdt@0.6.1:")
        depends_on("py-sdmetrics@0.4.1:")